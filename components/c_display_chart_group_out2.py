...
# category_list : .json
def create_display_chart_group_out2():
    ...
    return [
        ...
        html.Tr(
            html.Td(
                children=[
                    dcc.Graph(
                        figure=serve_fig_out_solar_capture_price("D"),
                        config={'displayModeBar': False},
                        id="graph_out_solar_capture_price",
                    ),
        ...
        html.Tr(
            html.Td(
                children=[
                    dcc.Graph(
                        figure=serve_fig_out_wind_capture_price("D"),
                        config={'displayModeBar': False},
                        id="graph_out_wind_capture_price",
                    ),
